...
# data inlezen
costsLL <- read.csv(file = "~/disks/y/ontwapps/Timer/Users/Stijn/Model/Databases/costs_LL.txt", header = TRUE)
costsUL <- read.csv(file = "~/disks/y/ontwapps/Timer/Users/Stijn/Model/Databases/costs_UL.txt", header = TRUE)
